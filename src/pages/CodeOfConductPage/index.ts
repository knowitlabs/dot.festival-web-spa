...
export const CodeOfConductPage = async () => {
  return html`<section class="dot section">
    <div class="dot container">
      ...
      <p class="dot">
        Contact anyone in the conference staff (look for staff badge) or use the
        slack channel.
      </p>

      <h2 class="dot">The Quick Version</h2>
      ...
      <p class="dot">
        ...
        point towards inclusive language is to avoid default-gendered words like
        "guys"/"gals"/"him"/"her" when talking generally about a group of
        people. A tip is to try out words like "people"/"everyone" or "the
        team"/"the developers".
      </p>
      ...
      <h2 class="dot">The Less Quick Version</h2>
      ...
      <p class="dot">
        ...
        immediately. Conference staff can be identified as they will be wearing
